	...
	<div class="container">
		...
		while ( have_posts() ) :
			...
			<div class="flex flex-col justify-between border border-border-color">
					...
					<header class="flex items-center gap-5 p-6">
						...
						<div class="grid text-text-color text-sm font-semibold gap-1">
							...
							<div class="flex items-center flex-wrap gap-2">
								...
								<div>
									<?php echo $experience ? esc_html__( 'Exp. ', 'cof' ) . esc_html( $experience ) . esc_html__( ' years', 'cof' ) : ''; ?>
								</div>
							</div>
						</div>
					</header>
				...
				<div class="px-6 pb-6">
					<a href="https://smartworking-solutions.com/book-a-chat/" class="button"><?php esc_html_e( 'Enquire for price', 'cof' ); ?></a>
				</div>
