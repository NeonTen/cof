<?php
/**
 * COF Woocommerce class for extra funtionality and overriding.
 *
 * @package COF
 */
...
/**
 * Main class for COF Woocommerce
 */
class COF_Woocommerce {
	...
	public function hooks() {
		...
		// wrapper.
		add_action( 'cof_after_header', [ $this, 'wp_add_wrapper_after_header' ], 20 );
		add_action( 'cof_before_footer', [ $this, 'wp_close_wrapper_before_footer' ] );
