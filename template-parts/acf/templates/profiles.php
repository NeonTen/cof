			...
			<div>
				...
				<ul class="flex items-center gap-2.5">
					...
					foreach ( $skills as $skill ) {
						...
						printf(
							'<li class=""><a class="text-xs font-extrabold text-white px-3 py-1.5 rounded-md%s" href="%s">%s</a></li>',
							esc_html( $color ),
				...
				<div class="flex justify-between items-center px-7">
					...
					<div class="text-xs font-extrabold text-white bg-blue-dark px-3 py-1.5 rounded-full">
						<?php echo $experience ? esc_html( $experience ) . esc_html__( ' years', 'cof' ) : ''; ?>
					</div>
				</div>
				<?php
				printf(
