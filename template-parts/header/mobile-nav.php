...
<!-- Mobile menu -->
<div class="mobile-menu slide-close | flex flex-col bg-dark-color text-white w-96 h-screen overflow-y-scroll px-10 py-2 fixed right-0 top-0 z-40 transition-all duration-200">
